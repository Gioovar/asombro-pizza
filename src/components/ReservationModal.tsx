                   ...
                   {step === 1 && (
                      <motion.div initial={{ x: 20, opacity: 0 }} animate={{ x: 0, opacity: 1 }}>
                         ...
                         <input 
                           ...
                           className="w-full bg-white/5 border border-white/10 rounded-2xl p-6 text-white text-lg outline-none focus:border-white/30 transition-all appearance-none cursor-pointer"
                           style={{ colorScheme: 'dark' }}
                         />
                         <button 
                            disabled={!date}
                            onClick={() => setStep(2)}
                            className="w-full mt-6 bg-white text-black py-5 rounded-2xl font-black flex items-center justify-center gap-2 hover:bg-neutral-200 disabled:opacity-30 transition-all"
                         >
